  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="companyEditTitle">Create Company</h5>
      ...
      <div class="modal-body">
        <form method="POST" action="{{ route('companies.create') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ $c->nama }}" required autocomplete="nama" autofocus>
